...
### Fixed
- fix(lance-edit): arreglar comportamiento del botón eliminar para evitar abrir panel lateral
- fix(lance-edit): agregar diálogo de confirmación antes de eliminar especie capturada
- fix(lance-edit): corregir codificación UTF-8 en textos del formulario
