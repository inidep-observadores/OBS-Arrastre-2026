...
public sealed class EspecieViejaConfiguration : IEntityTypeConfiguration<EspecieVieja>
{
    public void Configure(EntityTypeBuilder<EspecieVieja> builder)
    {
        builder.ToTable("especies_viejas");
