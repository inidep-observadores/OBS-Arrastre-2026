---
name: obs-arrastre-wpf
description: Project-local guidance for the OBS Arrastre 2026 .NET 10 WPF application. Use when working in this repository on app structure, WPF/XAML implementation, EF Core with SQLite, dependency injection, domain mapping, or schema-driven features tied to `docs/esquema.sql`.
---
...
3. Build with `dotnet build .\OBSArrastre2026.sln` after meaningful edits.
...
- The active solution is `OBSArrastre2026.sln`.
- The main executable project is `OBSArrastre2026.App`.
...
- For project changes, run `dotnet build .\OBSArrastre2026.sln`.
